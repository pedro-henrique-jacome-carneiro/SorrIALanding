...
![Tela inicial da landing page SorrIA](assets/Tela%20Inicial.png)
...
![Seção solução](assets/Solução.png)
...
![Seção de inteligência artificial](assets/Inteligência%20Artificial.png)
...
![Formulário de orçamento](assets/Orçamento.png)
